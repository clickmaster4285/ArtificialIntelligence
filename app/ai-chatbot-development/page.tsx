// app/ai-chatbot-development-company/page.tsx
...
import { getChatbotCityPageDataBySlug } from '@/data/ai-chatbot-city-pages-data';
...
export default function ChatbotMainPage() {
  const pageData = getChatbotCityPageDataBySlug('ai-chatbot-development-company');
  ...
  return (
    <PageLayout withGrain>
      ...
      <StatsSection
        title="AI Chatbot Development by the Numbers"
        stats={pageData.overview.stats ?? []}
      />
